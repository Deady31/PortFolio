...
var PROJECTS_PERSO=[
  ...
  {id:'tiktok',name:'Pop Culture Journalism',badge:'Projet Perso · Créa',status:'En cours',emoji:'📱',color:'#FF0050',colorBg:'rgba(255,0,80,.1)',img:'uploads/Logo%20divers/Screen%20Tiktok%20Deady.png',cat:'TikTok · Journalisme · Culture POP',tagline:'L\'actu culture POP, format court.',stack:['TikTok','Storytelling','Scripting'],problem:'La culture POP (anime, gaming, film) méritait un regard journalistique sérieux, pas juste du contenu viral creux.',hypothesis:'Un format court + angle journalistique = audience engagée sur des sujets de niche.',build:'Scripts, tournage, montage — solo. Angles éditoriaux sur gaming, anime, cinéma.',outcome:'Storytelling court-format, vulgarisation, pitcher une idée complexe en 60 secondes — compétences que j\'utilise directement en PM.',sections:[{label:"Le projet",text:"La culture POP (anime, gaming, cinéma) méritait un regard journalistique sérieux, pas juste du contenu viral. J'ai fait des vidéos d'analyse en format court — scripts, tournage, montage, seul.",isOutcome:false},{label:"Ce que j'en tire",text:"Storytelling court-format, vulgarisation, capacité à pitcher une idée complexe en 60 secondes. Des compétences que j'utilise directement en PM quand il faut embarquer une équipe ou défendre une roadmap.",isOutcome:true}],github:'https://github.com/Deady31'},
];
